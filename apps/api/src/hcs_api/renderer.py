...
.slide-frame { position: relative; min-width: 0; max-width: 100%; min-height: 0; aspect-ratio: 16 / 9; max-height: calc(100dvh - 150px); margin: 0 auto; width: min(100%, 1280px); }
